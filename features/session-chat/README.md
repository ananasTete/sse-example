...
data: {"p":"response","o":"BATCH","v":[{"p":"fragments","o":"APPEND","v":{"id":2,"type":"RESPONSE","content":"","references":[],"stage_id":1}},{"p":"has_pending_fragment","o":"SET","v":false}]}

data: {"p":"response/fragments/-1/content","o":"APPEND","v":"根据"}
