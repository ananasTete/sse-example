...
export function ChatPromptInput({
  ...
  return (
    <PromptInput
      ...
      className={cn(
        "rounded-[18px] border border-black/10 bg-white shadow-sm shadow-black/5",
        className,
      )}
    >
      <PromptInputBody>
        <PromptInputTextarea
          ...
          className="min-h-16 border-none bg-transparent px-4 py-3 text-[15px] leading-6 text-[#252820] placeholder:text-[#9a9c95] focus-visible:ring-0"
        />
      </PromptInputBody>
      {submitError ? (
        <div
